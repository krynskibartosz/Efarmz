...
export function createRandomProduct(): PRODUCT {
    return {
        ...
        availabilities_dates: [faker.date.future()],
        availabilities_days: [faker.date.weekday()],
        availability_date: faker.date.future(),
        bio: faker.datatype.number(20) > 10,
        ...
        description_long: faker.lorem.paragraph(),
        description_short: faker.lorem.sentence(),
        discount_tag: faker.datatype.number(20) > 10 ? 'discount' : '',
        dlc: faker.date.future().toString(),
        ecotax: parseFloat(faker.commerce.price()),
        exp_date: faker.date.future(),
        fresh: faker.datatype.number(20) > 10,
        gest_type: faker.datatype.number(20) > 10 ? 'gift' : '',
        id: faker.random.alphaNumeric(32),
        image: faker.image.imageUrl(),
        is_bio: faker.datatype.number(20) > 10,
        is_deals: faker.datatype.number(20) > 10,
        is_web_express: faker.datatype.number(20) > 10,
        labels: createRandomLabels(),
        link: faker.internet.url(),
        min_quantity: faker.datatype.number(10),
        name: faker.commerce.productName(),
        nbpers: faker.datatype.number(10),
        new: faker.datatype.number(20) > 10,
        options: createRandomOptions(),
        options_box: createRandomOptionsBox(),
        out_of_delivery_window: faker.datatype.number(20) > 10,
        parent_id: faker.random.alphaNumeric(32),
        populaire: faker.datatype.number(20) > 10,
        ...
        related: new Array(5).fill(createRandomProduct),
        sale_price: parseFloat(faker.commerce.price()),
        step: faker.datatype.number(10),
        stock_type: faker.datatype.number(100),
        subscription_available: faker.datatype.number(20) > 10,
        tag: faker.datatype.number(20) > 10,
        ...
        links: [
            {
                ...
                active: faker.datatype.number(20) > 10,
            },
        ],
